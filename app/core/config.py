...
class Settings(BaseSettings):
    ...
    terms_text: str = Field(
        default="يجب إدخال معلومات صحيحة والالتزام بشروط كل عرض.", alias="TERMS_TEXT"
    )
    provider_terms_version: str = Field(
        default="provider-v11.8", alias="PROVIDER_TERMS_VERSION"
    )
    provider_terms_text: str = Field(
        default=(
            "🛡 <b>مرحبًا بك في لوحة إدارة منصتك على CampusPass IQ</b>\n\n"
            "هذه اللوحة صُممت لتنظيم بيع خدماتك للطلاب، متابعة الطلبات، وإدارة العروض "
            "بصلاحيات واضحة للمالك والموظفين. يرجى قراءة آلية العمل قبل البدء.\n\n"
            "1️⃣ <b>رسوم CampusPass واضحة:</b> سعر العرض تحدده منصتك. أجور خدمة البوت الثابتة، إن وُجدت، "
            "تُعرض منفصلة وتُضاف فوق سعر العرض لتغطية الاستضافة السحابية والتشغيل والأمان. وإذا كانت للمنصة "
            "نسبة إدارة تعاقدية مضبوطة من مالك النظام، فتُحسب منفصلة وتظهر في السجلات المالية ولا تُخفى عنك.\n\n"
            "2️⃣ <b>الشفافية:</b> تستطيع الصلاحيات المخولة متابعة الطلبات والحركات والطلاب المرتبطين "
            "بعمليات منصتك ضمن حدود الدور الممنوح لكل موظف، مع تسجيل العمليات الحساسة للمراجعة.\n\n"
            "3️⃣ <b>الخصومات والولاء:</b> يمكنك إنشاء أكواد وحملات خاصة لطلاب منصتك. وقد تتيح خطة "
            "المنصة أو برامج النمو مزايا إضافية كلما توسع نشاطك، وفق الشروط المعلنة داخل النظام.\n\n"
            "4️⃣ <b>الأمان والخصوصية:</b> الوصول إلى بيانات المنصة معزول بالصلاحيات، والحقول الحساسة "
            "تخضع لضوابط الحماية والتدقيق. أنت مسؤول عن صحة بيانات العروض، الحسابات، الأسعار، وحقوق "
            "استخدام الخدمات التي تضيفها.\n\n"
            "بالضغط على «✅ أوافق وأبدأ العمل» تؤكد أنك قرأت سياسة العمل والخصوصية وتوافق على الالتزام بها."
        ),
        alias="PROVIDER_TERMS_TEXT",
    )
    privacy_text: str = Field(
        default=(
            "نجمع الحد الأدنى اللازم لتنفيذ الطلبات والدعم. تُشفّر بيانات الاسم والهاتف "
            "وبيانات التفعيل الحساسة، وتُسجل مشاهدة الأسرار والمرفقات. تُحفظ السجلات "
            "المالية والتشغيلية الضرورية وفق سياسة النظام، ولا يُرسل سياقك للمساعد "
            "الذكي إلا بموافقتك وبعد تنقيحه."
        ),
        alias="PRIVACY_TEXT",
    )
